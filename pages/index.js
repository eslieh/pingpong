...
function getConnectionHelpLine() {
  ...
  if (typeof window !== 'undefined' && window.location.protocol === 'https:') {
    return 'Set NEXT_PUBLIC_WS_URL on Vercel to your VPS WebSocket URL (wss://.../ws).';
  }

  return 'Run npm run dev:ws locally, or set NEXT_PUBLIC_WS_URL for production.';
}
